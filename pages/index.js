import { Container, Content, Image, Pokemon,Number,PokemonName,Type,Flex } from '../styles/home'
  ...
  return (
    ...
    <Content>
      {pokemons.map((poke) => {
        ...
        <section style={{background:"pink",margin:"10px",padding:"6px 3px",position:"relative"}}>
